...
from financial_data.transformation import DatasetRunFinalizer, KeyrateWatermarkProvider
...
def test_keyrate_pipeline_end_to_end(
    ...
    assert objects == [f'cbr/keyrate/ingestion_date={pipeline.pipeline_run_date.isoformat()}/run_id={run_id}/part-0000.html']
